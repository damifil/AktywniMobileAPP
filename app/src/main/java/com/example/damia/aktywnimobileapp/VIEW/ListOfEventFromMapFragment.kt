 ...
 * [ListOfEventFromMapFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ListOfEventFromMapFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class ListOfEventFromMapFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ListOfEventFromMapFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                ListOfEventFromMapFragment().apply {
